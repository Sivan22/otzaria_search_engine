...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 371766336;
...
fn wire__crate__api__search_engine__SearchEngine_index_text_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "SearchEngine_index_text",
            port: Some(port_),
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        ...
                        let output_ok = crate::api::search_engine::SearchEngine::index_text(
                            &mut *api_that_guard,
                            api_id,
                            &api_title,
                            &api_text,
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    ...
                    let mut api_that_guard = api_that_guard.unwrap();
                    let output_ok =
                        Result::<_, ()>::Ok(crate::api::search_engine::SearchEngine::search(
                            &mut *api_that_guard,
                            &api_query,
                            &api_books,
                        ))?;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__search_engine__SearchEngine_index_text_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        2 => wire__crate__api__search_engine__SearchEngine_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        3 => wire__crate__api__search_engine__SearchEngine_search_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        4 => wire__crate__api__search_engine__test_bindings_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
